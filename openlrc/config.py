...
class TranslationConfig:
    ...
    String and path values are the easiest to serialize in CLI configs, but
    programmatic callers may also pass richer runtime values such as
    ``ModelConfig`` and in-memory glossary dicts.
